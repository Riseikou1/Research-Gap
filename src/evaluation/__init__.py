...
from .verification import counterexample_confirmation_rate, counterexample_discovery_rate, evaluate_verification
...
__all__ = [
    "AblationPrediction", "AblationPredictionGenerator", "AblationVariant", "AttributionMetrics", "EvaluationDataset", "EvaluationFailure",
    ...
    "aggregate_extraction", "aggregate_performance", "cache_hit_rate", "counterexample_confirmation_rate", "counterexample_discovery_rate",
